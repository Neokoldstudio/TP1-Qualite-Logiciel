...
link github: https://github.com/andre-meneses/TP1-Qualite-Logiciel
...
- Assurez-vous d'installer les dépendances nécessaires, notamment les fichiers JAR pour Tloc et Tassert, avant de construire le projet Tls.
